    ...
    return (
        <form className="space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8">
            ...
            <div>
                ...
                <input type="email" name="email" id="email" placeholder="name@company.com" className="border-2 outline-none sm:text-sm rounded-lg focus:ring-blue-500 block w-full focus:border-blue-500 p-2.5 bg-gray-600 border-gray-500 placeholder-gray-400 text-white"/>
            </div>
