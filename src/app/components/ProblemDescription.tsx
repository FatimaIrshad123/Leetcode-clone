        ...
        await runTransaction(firestore, async (transaction) => {
            ...
            if (userDoc.exists() && problemDoc.exists()){
                if (disliked){
                    ...
                    transaction.update(problemRef, {
                        dislkes: problemDoc.data().dislikes + 1
                    })
                    setCurrentProblem((prev) => prev ? {...prev, dislikes: prev.dislikes + 1} : null);
        ...
        <div className='flex px-0 py-4 h-[calc(100vh-94px)] overflow-y-auto'>
            <div className='px-5'>
                ...
                <div className='w-full'>
                    ...
                    {/* Examples */}
                    <div className='mt-4'>
                        {problem?.examples.map((example:any,index:any) => {return (
                        <div key={example.id}>
        ...
        const getCurrentProblem = async () => {
            ...
            if(docSnap.exists()){
                ...
                setProblemDifficultyClass(
                    problem.difficulty === "Easy" ? "bg-olive text-olive" : problem.diffulty === "Medium" ? "bg-dark-yellow text-dark-yellow" : "bg-dark-pink text-dark-pink"
                )
